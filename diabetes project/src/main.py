...
if __name__ == "__main__":
    ...
    #Out Sample Forecast (rolling)
    print("Out of Sample Forecast, different files:")
    predictions = model_fit.forecast(steps = np.size(test))#check parameters and in sample     
    targets = test
    #predictions = []
    ...
    RMSE = sqrt(mean_squared_error(targets, predictions)) #performance??
    print('Test RMSE: %.3f' % RMSE)
    Performance = rmse(targets, predictions)
    print('Test Performance: %.3f' % Performance)
